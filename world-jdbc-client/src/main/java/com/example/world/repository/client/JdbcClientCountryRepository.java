...
public class JdbcClientCountryRepository implements CountryRepository {
	...
	public Country add(Country country) {
		int rowsAffected = jdbcClient.sql(INSERT_COUNTRY).param("code", country.getCode())
				.param("name", country.getName()).param("continent", country.getContinent())
				.param("population", country.getPopulation()).param("area", country.getSurfaceArea()).update();
	...
	public Country update(Country country) {
		...
		jdbcClient.sql(UPDATE_COUNTRY).param("population", country.getPopulation())
				.param("area", country.getSurfaceArea()).param("code", country.getCode()).update();
		return country;
	}
